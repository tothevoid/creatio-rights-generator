const getHeaderRows = (tableCatpionResult, rightsResult) => {
    const tableCaption = (tableCatpionResult.Caption) ? 
        tableCatpionResult.Caption : 
        tableCatpionResult.DefaultCaption;
